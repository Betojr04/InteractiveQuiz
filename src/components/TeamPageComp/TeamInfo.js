...
export const teamMembers = [
  ...
  {
    name: "AUSTIN LUTTERLOH",
    role: "CFO",
    img: "https://randomuser.me/api",
    bio: "Austin is an accomplished professional with a strong background in finance and accounting. He holds a Bachelor’s degree in Accounting, with minors in Finance and Economics, as well as a Master’s degree in Accounting from Grand Canyon University. Throughout his career, Austin has gained valuable experience in both financial planning and analysis (FP&A) and portfolio management of commercial real estate (CRE) investments, overseeing a portfolio of $2.5B in assets under management across various industries.Outside of work, he enjoys pursuing his hobbies, including running, weight training, home remodel projects, golf, and traveling with his wife."
  },
  {
